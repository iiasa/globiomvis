...
As explained in the [installation article](installation.html), GDXRRW will load the GAMS GDX libraries via the `R_GAMS_SYSDIR` environment variable when issuing
