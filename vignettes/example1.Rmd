...
As explained in the article [Install R, packages and other relevant software](https://iiasa.github.io/globiomvis/articles/globiomvis1.html), GDXRRW will load the GAMS GDX libraries via the `R_GAMS_SYSDIR` environment variable when issuing
