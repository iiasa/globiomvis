...
* **MiKTeX** is one of the distributions TeX/LaTeX and related programs. RStudio facilitates the use of LaTex through Rmarkdown but this requires the installation of [MiKTeX](https://miktex.org). If you want to learn more about this see [here](https://bookdown.org/yihui/rmarkdown/).
