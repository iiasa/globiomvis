...
It is essential that R and GAMS are linked to be able to read gdx files. See the vignette [1. Install R, packages and other relevant software](https://iiasa.github.io/rglobiom/articles/rglobiom1.html) for more information on how to do this. Here we do it manually, using the command `igdx()`.
...
data("main_output_comb", package="rglobiom")
...
```{r echo=FALSE}
knitr::include_graphics("rglobiom2_files/trend_plot_example.png")
```
