...
The approach is very similar to producing the [30 region map](https://iiasa.github.io/rglobiom/articles/rglobiom4.html) so we will only provide a brief example here using LUID level data. 
...
```{r echo=FALSE}
knitr::include_graphics("rglobiom5_files/luid.png")
```
